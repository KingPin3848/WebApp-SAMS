...
namespace SAMS.Controllers
{
    public class RoomLocationInfoController : Controller
    {
        ...
        {
            if (id == null || _context.roomLocationInfoModels == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.roomLocationInfoModels == null)
            {
                return Problem("Entity set 'ApplicationDbContext.roomLocationInfoModels'  is null.");
            }
            var roomLocationInfoModel = await _context.roomLocationInfoModels.FindAsync(id);
            if (roomLocationInfoModel != null)
            {
        ...
        {
          return (_context.roomLocationInfoModels?.Any(e => e.RoomId == id)).GetValueOrDefault();
        }
    }
}
