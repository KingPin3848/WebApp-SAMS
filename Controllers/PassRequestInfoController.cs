...
namespace SAMS.Controllers
{
    public class PassRequestInfoController : Controller
    {
        ...
        {
            if (id == null || _context.passRequestInfoModels == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.passRequestInfoModels == null)
            {
                return Problem("Entity set 'ApplicationDbContext.passRequestInfoModels'  is null.");
            }
            var passRequestInfoModel = await _context.passRequestInfoModels.FindAsync(id);
            if (passRequestInfoModel != null)
            {
        ...
        {
          return (_context.passRequestInfoModels?.Any(e => e.PassRequestId == id)).GetValueOrDefault();
        }
    }
}
