...
{
    public class EASupportInfoController : Controller
    {
        private readonly ApplicationDbContext _context;

        public EASupportInfoController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View("~/Views/InfoManagement/EASupportInfo/Index.cshtml", await _context.eASuportInfoModels.ToListAsync());
        }

        // GET: EASupportInfo/Details/5
        public async Task<IActionResult> Details(string id)
        {
            ...
            return View("~/Views/InfoManagement/EASupportInfo/Details.cshtml", eASuportInfoModel);
        }

        // GET: EASupportInfo/Create
        public IActionResult Create()
        {
            return View("~/Views/InfoManagement/EASupportInfo/Create.cshtml");
        }

        // POST: EASupportInfo/Create
        ...
        public async Task<IActionResult> Create([Bind("EaID,EaFirstNameMod,EaMiddleNameMod,EaLastNameMod,EaPreferredNameMod,EaEmailMod,EaPhoneMod,EaStudentManaged")] EASuportInfoModel eASuportInfoModel)
        {
            ...
            return View("~/Views/InfoManagement/EASupportInfo/Create.cshtml", eASuportInfoModel);
        }

        // GET: EASupportInfo/Edit/5
        public async Task<IActionResult> Edit(string id)
        {
            ...
            return View("~/Views/InfoManagement/EASupportInfo/Edit.cshtml", eASuportInfoModel);
        }

        // POST: EASupportInfo/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            return View("~/Views/InfoManagement/EASupportInfo/Delete.cshtml", eASuportInfoModel);
        }

        // POST: EASupportInfo/Delete/5
