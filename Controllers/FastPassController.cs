...
namespace SAMS.Controllers
{
    public class FastPassController : Controller
    {
        ...
        {
            if (id == null || _context.fastPassModels == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.fastPassModels == null)
            {
                return Problem("Entity set 'ApplicationDbContext.fastPassModels'  is null.");
            }
            var fastPassModel = await _context.fastPassModels.FindAsync(id);
            if (fastPassModel != null)
            {
        ...
        {
          return (_context.fastPassModels?.Any(e => e.FastPassIDMod == id)).GetValueOrDefault();
        }
    }
}
